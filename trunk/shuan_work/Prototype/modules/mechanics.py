...
class Mission(layer.Layer):
    ...
    def __init__(self):
        ...
        # Batches
        self.objectsBatch = batch.BatchNode()
        self.add_self(self.objectsBatch, z=5)
        ...
        self.add_self(self.lifeLabel, z=10)
        self.add_self(self.energyLaber, z=10)
        self.add_self(self.scoreLabel, z=10)
        self.add_self(self.devicesLabel, z=10)
    ...
    def remove_self(self, item):
        super(Mission, self).remove(item)
